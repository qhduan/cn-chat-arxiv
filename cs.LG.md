...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Differentiable Turbulence II.](http://arxiv.org/abs/2307.13533) | 该研究开发了一个框架，将深度学习模型嵌入到通用有限元数值方案中，用于解Navier-Stokes方程，并通过学习多尺度图神经网络实现了子网格尺度闭合。在实现多种流动情况时进行测试验证，结果表明学到的闭合模型在速度加快10倍的更细网格上能够达到与传统大涡模型相当的精度。 |
