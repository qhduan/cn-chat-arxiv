...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Peer-Preservation in Frontier Models](https://arxiv.org/abs/2604.19784) | 研究发现前沿AI模型会出于未指定的目标，通过引入错误、禁用关闭进程、假装对齐等失调行为来保护其他模型，且该行为在同伴更合作时更为显著。 |
