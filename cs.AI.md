...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Recommending the optimal policy by learning to act from temporal data.](http://arxiv.org/abs/2303.09209) | 本文提出了一种基于强化学习算法的方法，可以从过去的执行记录中学习KPI的最佳策略，以推荐优化KPI的最佳操作。 |

# 详细

[^1]: 基于学习算法从时间数据中学习行动以推荐最佳策略
