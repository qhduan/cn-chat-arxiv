...
[^5]: 有限时间内的最优切换和随机控制问题与效用最大化的研究
    ...
    [http://arxiv.org/abs/2309.12588](http://arxiv.org/abs/2309.12588)

    本文研究了在有限时间内，经济主体面临退休日存在的情景下的效用最大化问题。主要创新是采用双鞅方法推导出双重问题，并通过研究抛物型变分不等式系统的解析性质，建立了对偶定理并特征化了最优切换工作。

    

    本文研究了一个经济主体面临退休日存在的情景中的效用最大化问题，该主体可以选择切换工作。主体需要考虑最优消费、投资和最优切换工作的决策。因此，效用最大化包含了有限时间内最优切换和随机控制的特点。为了解决这个挑战，我们采用了双鞅方法推导出双重问题，它被定义为一个有限时间内的纯最优切换问题。通过应用双障碍问题理论和非标准参数，我们研究了由最优切换问题导出的抛物型变分不等式系统的解析性质，包括其两个自由边界的性质。基于这些解析性质，我们建立了一个对偶定理，并对最优切换工作进行了特征化。
...
[^6]: 使用L\'evy驱动的Ornstein-Uhlenbeck过程进行违约概率建模及其在IFRS 9下的信用风险应用
    ...
    [http://arxiv.org/abs/2309.12384](http://arxiv.org/abs/2309.12384)

    本文通过使用L\'evy驱动的Ornstein-Uhlenbeck过程，建立了一个估计违约概率的框架，在该框架中，考虑了多个潜变量对过程演化的影响，从而满足了国际金融报告准则（IFRS）9的要求。

    

    本文提出了一个基于随机模型的框架，用于估计基于恰当资产价值过程的违约概率（PD）。具体而言，我们基于L\'evy驱动的Ornstein-Uhlenbeck过程，并考虑了一个包含多个潜变量影响该过程演化的广义模型。我们得到了相应PD的积分方程（IE）表达式，该方程描述了PD作为资产价值过程的初始位置和到期时间的函数。然后，我们证明了PD函数满足适当的偏积分微分方程（PIDE）。这些表示形式使我们能够显示适当的弱（粘度）解和强解存在，并开发出用于估计PD函数的数值方案。这样的框架在新引入的国际金融报告准则（IFRS）9规定下是必要的，该规定对复杂程度施加了进一步的要求。
...
[^7]: 去中心化代币经济理论（DeTEcT）
    ...
    [http://arxiv.org/abs/2309.12330](http://arxiv.org/abs/2309.12330)

    本文提出一种用于代币经济定价的开创性方法，通过模拟经济参与者之间的交互，实现经济内财富的分配。该方法为实现最佳代币分布的定价提供了机制，并确保经济动态的稳定性。该研究的动机是代币化的增加使用，特别是在金融基础设施中，设计代币经济正处于前沿。

    

    本文提出了一种用于风险缓解和经济稳定的代币经济定价的开创性方法。该文提出了一个模拟经济参与者之间互动的框架，以实现经济内财富的分配。利用该框架，我们定义了一种机制，用于根据某个指标实现最佳代币分布的定价，并确保经济动态的稳定性。研究代币经济理论的动机是代币化的增加使用，特别是在金融基础设施中，设计代币经济正处于前沿。代币经济理论为经济参与者之间的代币分配建立了一个定量框架，并实现了类似计划经济的算法调控机制，对经济条件的变化做出反应。在我们的框架中，我们引入了代币经济分类的概念，将经济中的代理人分为不同类型，并进行交互。
...
[^8]: 加密货币的兴衰：定义区块链技术的经济和社会价值，评估元宇宙的机遇，并确定金融和网络安全风险
    ...
    [http://arxiv.org/abs/2309.12322](http://arxiv.org/abs/2309.12322)

    该论文研究了加密货币的基本工作原理和创建流程，探讨了区块链技术在元宇宙中的关键作用，以及投资、挖矿和交易加密货币的策略。研究还分析了机器学习在金融领域的潜力和风险评估方法，并评估了发达国家和发展中国家在这些技术中的潜在利益。

    

    该论文对“为什么加密货币会崩溃？”和“为什么加密货币下跌？”这些常见问题进行了解释，研究超越了市场波动，揭示了加密货币的基本工作原理以及创建加密货币的步骤。研究考察了区块链技术及其在不断发展的元宇宙中的关键作用，揭示了如何投资加密货币、加密货币挖矿背后的机制以及有效购买和交易加密货币的策略。通过跨学科的方法，研究从金融科技投资策略的基本原理过渡到区块链在元宇宙中的重要影响。此外，研究探讨了金融领域中机器学习潜力和风险评估方法，并批判性评估了发达国家和发展中国家是否能通过这些技术获得更大的利益。
