...
| [^5] | [Common Firm-level Investor Fears: Evidence from Equity Options.](http://arxiv.org/abs/2309.03968) | 该论文通过分析个股期权的横截面分布，发现了一种新型风险——共同的企业级投资者恐惧。股票对共同的坏恐惧较好恐惧具有较高的敏感度，投资者对于暴露于共同的坏恐惧要求较高的补偿。共同的坏恐惧的风险溢价估计范围为每年-5.63%至-4.92%。 |
| [^6] | [Fourier Neural Network Approximation of Transition Densities in Finance.](http://arxiv.org/abs/2309.03966) | 本文提出了FourNet，一种使用高斯激活函数的单层神经网络，能够以任意精度逼近具有已知傅里叶变换的过渡密度，并通过严密的误差分析给出了估计误差和非负性损失的界限。 |
...
| [^8] | [Cognitive Aging and Labor Share.](http://arxiv.org/abs/2308.14982) | 该研究将劳动份额的下降与认知衰老联系起来，提出了一个新颖的宏观经济模型。模型表明，工业化导致人口老龄化，老龄消费者认知能力的下降减少了对新产出变体的需求，从而导致劳动份额的下降。 |
| [^9] | [The Inflation Attention Threshold and Inflation Surges.](http://arxiv.org/abs/2308.09480) | 本论文研究了通胀关注度与通胀激增之间的关系，发现在通胀率低稳定时，人们关注度较低，但一旦通胀率超过4%，关注度会明显增加，高关注区域的关注度是低关注区域的两倍。这种关注阈值的存在导致了状态依赖效应，即在宽松货币政策时，成本推动冲击对通胀的影响更大。这些结论有助于理解最近美国的通胀激增现象。 |
| [^10] | [Nonlocality, Nonlinearity, and Time Inconsistency in Stochastic Differential Games.](http://arxiv.org/abs/2112.14409) | 本文在非局部完全非线性抛物型系统中证明了解的存在性和唯一性，并进行了稳定性分析。通过将随机微分博弈理论与时间不一致偏好相结合，扩展了现有研究的范畴，从而在金融经济学中推动了鲁棒随机控制和相对绩效关注下的博弈的发展。 |
