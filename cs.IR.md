...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Bridging Language and Items for Retrieval and Recommendation](https://arxiv.org/abs/2403.03952) | 本文介绍了BLaIR，一个专门针对推荐场景的预训练句子嵌入模型，通过学习商品元数据与自然语言语境之间的相关性，提高了检索和推荐商品的效果。 |
