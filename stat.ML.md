...
| Ref | Title | Summary |
| --- | --- | --- |
| [^1] | [Neural Network-Based Score Estimation in Diffusion Models: Optimization and Generalization.](http://arxiv.org/abs/2401.15604) | 本文提出了基于神经网络的扩散模型中分数估计的优化和泛化方法，并建立了对分数估计进行分析的数学框架。 |

# 详细

[^1]: 基于神经网络的扩散模型中的分数估计：优化和泛化
